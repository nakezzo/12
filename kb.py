...
def menu(userid):
    ...
    btn2 = InlineKeyboardButton("⚡️ | Статистика", callback_data='stats')
    btn3 = InlineKeyboardButton("🎲 | Игровой канал", url=BETS_LINK)
    btn5 = InlineKeyboardButton("👑 | Сделать ставку", url='t.me/send?start=IVn0ttZb2SIu')
    btn6 = InlineKeyboardButton("👮 | Тех. Поддержка", url='t.me/n1ce_Tag')
